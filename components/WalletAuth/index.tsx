...
export const WalletAuth = ({ user, setUser }: WalletAuthProps) => {
  ...
  return (
    <div className="relative flex flex-row items-center justify-between shadow-none w-full">
      ...
      {!user ? (
        ...
        <div className="flex flex-col items-center space-y-2">
          ...
          <Button onClick={handleSignOut} variant="primary" size="md">
            Sign Out
          </Button>
        </div>
      )}
